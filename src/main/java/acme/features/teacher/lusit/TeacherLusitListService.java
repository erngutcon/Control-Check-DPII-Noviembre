...
@Service
public class TeacherLusitListService implements AbstractListService<Teacher, Lusit> {
	...
	public Collection<Lusit> findMany(final Request<Lusit> request) {
		...
		result = this.repository.findManyLusitsByTeacher(request.getPrincipal().getActiveRoleId());
